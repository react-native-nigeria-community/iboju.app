  ...
  return (
    <div className="flex-1">
      ...
      >
        ...
        <div
          className={`absolute left-1/2 ${isInverted ? 'top-[-60px]' : 'bottom-[-60px]'} transform -translate-x-1/2 bg-black rounded-[32px] p-2 border-4 border-black shadow-md`}
        >
        ...
        {isInverted && (
          <>
            <h2
              ...
              suppressContentEditableWarning
              onInput={(e) => setTitle(e.currentTarget.textContent)}
              className="text-xl font-bold outline-none mt-96"
              style={{ unicodeBidi: 'isolate', direction: 'ltr', textAlign }}
            >
              {title}
            </h2>
